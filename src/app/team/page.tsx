...
const teamLawyers = {
  han: {
    ...
    summary: "家业传承财富中心主任，广东省律师协会信托与财富管理专委会副主任，广州市律师协会信托与财富管理专委会秘书长。20年+法律从业经验，15年+财富传承领域实务，成功落地1000+家企专项服务项目。团队深入研究中国家族（企业）成长模式、私人财富管理与传承等理论与实务，并从文化、治理和成员关系的视角关注民营家族企业的代际传承。原创\"人财保传\"理论体系，\"人+财+文化\"三维传承模型。",
